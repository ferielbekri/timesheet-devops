...
public class EntrepriseSeriveceImplTests {
	...
	public void testRetrieveAllEntreprise() {
		...
		Assertions.assertEquals(8, ListeEntreprise.size());;
	...
	public void testUpdateEntreprise() throws ParseException{
		Entreprise e = new Entreprise(39,"rafik","mastouri");
	...
	public void testRetrieveEntreprise(){
		Entreprise entrepriseRetrieved = entrepriseService.retrieveEntreprise(39);
		Assertions.assertEquals(39, entrepriseRetrieved.getId());
